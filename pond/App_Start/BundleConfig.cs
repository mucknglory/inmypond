...
namespace Pond.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // jQueryUI CSS
            bundles.Add(new StyleBundle("~/Scripts/plugins/jquery-ui/").Include(
            ...
            //jquery-typeahead
            bundles.Add(new ScriptBundle("~/plugins/jquery-typeahead").Include(
                "~/Scripts/plugins/jquery-typeahead/jquery.typeahead.min.js"));

            //jquery-typeahead
            bundles.Add(new StyleBundle("~/Content/plugins/jquery-typeahead").Include(
                "~/Content/plugins/jquery-typeahead/jquery.typeahead.min.css"));
        }
    }
}
